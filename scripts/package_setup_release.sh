...
#
# Writes: dist/Alone-in-the-Dark-The-New-Nightmare-Recompiled-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix Alone-in-the-Dark-The-New-Nightmare-Recompiled \
  --exe-name Alone_in_the_Dark__The_New_Nightmare \
  --display-name "Alone in the Dark: The New Nightmare" \
