...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Alone in the Dark: The New Nightmare",
    .project_root_env = "ALONE_IN_THE_DARK__THE_NEW_NIGHTMARE_PROJECT_ROOT",
    .build_dir_env = "ALONE_IN_THE_DARK__THE_NEW_NIGHTMARE_BUILD_DIR",
    .force_setup_env = "ALONE_IN_THE_DARK__THE_NEW_NIGHTMARE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_028.01_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Alone_in_the_Dark__The_New_Nightmare",
    .prepare_note =
